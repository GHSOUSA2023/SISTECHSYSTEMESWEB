export default function PackagesTablePending({ packages = [], onDelete, onEdit }) {
      ...
      <table className="min-w-full bg-white border border-gray-300">
        <thead>
          <tr>
            ...
            <th className="px-6 py-3 border-b text-center">Days Overdue</th>
            <th className="px-6 py-3 border-b text-center">Quantity</th>
